...
<div class="col-12 col-sm-6 col-md-4">
    <div class="card  cartepazzesgravate" style="width: 18rem;">
       <img src="../Images/50.jpeg" height=150px class="card-img-top" alt="...">
         <div class="card-body">
         <h5 class="card-title">Sconto del 50%</h5>
         <a href="#" class="btn btn-primary">OTTIENI SCONTO!</a>
        </div>
     </div>
   </div>
    ...
    <div class="col-12 col-sm-6 col-md-4">
      <div class="card  cartepazzesgravate" style="width: 18rem;">
       <img src="../Images/1-2.jpeg" height=150px class="card-img-top" alt="...">
         <div class="card-body">
         <h5 class="card-title">Prendi 2 paghi 1</h5>
         <a href="#" class="btn btn-primary">OTTIENI SCONTO!</a>
         </div>
        </div>
       </div>
    ...
    <div class="col-12 col-sm-6 col-md-4">
      <div class="card  cartepazzesgravate" style="width: 18rem;">
       <img src="../Images/20.png" height=126px class="card-img-top" alt="...">
         <div class="card-body">
         <h5 class="card-title">20% di sconto sui prodotti per la casa</h5>
         <a href="#" class="btn btn-primary">OTTIENI SCONTO!</a>
         </div>
        </div>
       </div>
    ...
    <div class="col-12 col-sm-6 col-md-4">
      <div class="card  cartepazzesgravate" style="width: 18rem;">
       <img src="../Images/bollino%20spesa.png" height=150px class="card-img-top" alt="...">
         <div class="card-body">
         <h5 class="card-title">Bollini spesa. Più spesa fai, più sconto hai!</h5>
         <a href="#" class="btn btn-primary">OTTIENI SCONTO!</a>
         </div>
        </div>
       </div>
    ...
    <div class="col-12 col-sm-6 col-md-4">
      <div class="card  cartepazzesgravate" style="width: 18rem;">
       <img src="../Images/25.jpeg"  height=150px  class="card-img-top" alt="...">
         <div class="card-body">
         <h5 class="card-title">25% di sconto sul reparto colazione</h5>
         <a href="#" class="btn btn-primary">OTTIENI SCONTO!</a>
         </div>
        </div>
       </div>
    ...
    <div class="col-12 col-sm-6 col-md-4">
      <div class="card  cartepazzesgravate" style="width: 18rem;">
       <img src="../Images/monopattinone.jpeg" height=150px class="card-img-top" alt="...">
         <div class="card-body">
         <h5 class="card-title">Vinci 1 monopattino elettrico. E' tutto gratis!</h5>
         <a href="#" class="btn btn-primary">OTTIENI SCONTO!</a>
         </div>
        </div>
       </div>
